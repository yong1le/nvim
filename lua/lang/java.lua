return {
  {
    ...
    config = function()
      ...
      local function jdtls_on_attach(_, bufnr)
        ...
        vim.keymap.set('x', '<leader>ljv', "<esc><cmd>lua require('jdtls').extract_variable(true)<cr>",
          { buffer = bufnr, desc = "Extract Variable" })
        vim.keymap.set('n', '<leader>ljc', "<cmd>lua require('jdtls').extract_constant()<cr>",
          { buffer = bufnr, desc = "Extract Constant" })
        vim.keymap.set('x', '<leader>ljc', "<esc><cmd>lua require('jdtls').extract_constant(true)<cr>",
          { buffer = bufnr, desc = "Extract Constant" })
        vim.keymap.set('x', '<leader>ljm', "<esc><Cmd>lua require('jdtls').extract_method(true)<cr>",
